...
<div class="wrap640 o-h">
    ...
    <mip-sidebar id="right-sidebar" layout="nodisplay" side="left" class="fixed-nav mip-layout-nodisplay mip-element" aria-hidden="true" style="display: none;">
        <div class="inner">
            ...
            <dl>
                <dt><a target="_blank" href="{{url('')}}/{{$item->en_name}}">
            ...
            <div class="ecode-box clr">
                <div class="pic">
                    <mip-img popup="" src="{{随机图片()}}" alt="漂亮女人二维码" class="mip-element mip-layout-container mip-img-loaded">
        ...
        <ul class="catepic_left" id="ajax-list">
            ...
            <li>
                <a href="{{url('')}}/{{$item->en_name}}/{{$item->id}}.html" class="content">
                    <i><mip-img class="lazyload mip-element mip-layout-container mip-img-loaded" data-original="" src="{{随机图片()}}" alt="{{$item->title}}"><img class="mip-fill-content mip-replaced-content" src="{{随机图片()}}" alt="{{$item->title}}"></mip-img></i>
                    <h5>{{$item->title}}</h5>
                </a>
